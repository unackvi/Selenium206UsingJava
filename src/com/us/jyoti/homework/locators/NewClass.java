...
public class NewClass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// TimeOutException  with ExplicitlyWait but not Thread.sleep above? 	
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='text'][text()='Galaxy Corporation']")));
		
		//Click Customer Settings button of Galaxy corp		
		WebElement settings3 = driver.findElement(By.xpath("//div[@class='text'][text()='Galaxy Corporation']"));
		js1.executeScript("arguments[0].click()", settings3);
		
		//div[@class='title'][text()='Galaxy Corporation']/../div[2]
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='title'][text()='Galaxy Corporation']/../div[2]")));
		
		//Click Customer Settings button of Galaxy corp		
		WebElement settings4 = driver.findElement(By.xpath("//div[@class='title'][text()='Galaxy Corporation']/../div[2]"));
